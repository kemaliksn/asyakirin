...
<head>
    ...
    <title>Tambah Akun - ASY-SYAAKIRIIN</title>
    ...
    <style>
        * { font-family: 'Plus Jakarta Sans', sans-serif; }
        ...
        .info-box { background: #e8f5ee; border: 1px solid #aed4bc; border-radius: 10px; padding: 14px; font-size: 12.5px; color: #145c33; margin-bottom: 20px; }
    </style>
</head>
<body>
...
<header class="topbar">
    <div style="display:flex;align-items:center;gap:8px;">
        ...
        <span style="color:#ccc;">/</span>
        <span style="font-size:13px;font-weight:600;color:#1a6b3c;">Tambah Akun</span>
    </div>
...
<div class="content-inner">
    ...
    <h1 class="page-title">Tambah <span>Akun Baru</span></h1>

    <div class="info-box">
        ℹ️ Akun baru akan langsung aktif dan dapat login menggunakan email & password yang didaftarkan.
    </div>
